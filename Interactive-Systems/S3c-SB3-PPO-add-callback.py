...
eval_env = RecordVideo(eval_env, video_folder=f"./videos/{env_name}-agent-post-train", name_prefix=f"{algorithm}",
                  episode_trigger=lambda x: True)
...
record_video(env_name, model, video_length=1000, prefix=f"{algorithm}-{env_name}")
